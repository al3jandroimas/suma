...
Original file is located at
    https://colab.research.google.com/drive/1UUWI6tBsrDk_gwpUBOLxNMufuAAJRJsR
"""
...
experiment_id = '%s-%s' % ('bn2_omniglot_tp_ft_1s_20w', time.strftime("%Y_%m_%d", time.localtime()))
